...
public class CustomDialogFragment extends DialogFragment{
    ...
    private void setForgotESL(Dialog d){
        ...
        if(this.attendanceStudent.getAttendance().getTempAttendanceState() == 0
                &&this.attendanceStudent.getAttendance().getRequestForgotESLTime() == null
                &&this.attendanceStudent.getAttendance().getConfirmTime() != null){
            //ACKですでに出席済み.
            layout.setVisibility(View.GONE);
        }else{
            //ESL忘れレイアウト
            ...
            if(this.attendanceStudent.getAttendance().getRequestForgotESLTime() != null){
                //ESL忘れ申請をすでに行っているので
                //解除ボタンを出す.
    ...
    private void setConfirmTodayAttendanceTime(Dialog d){
        ...
        if(this.attendanceStudent.getAttendance().getTempAttendanceState() == 0
            ...
            confirmTV.setText(this.attendanceStudent.getAttendance().getConfirmTime());
