...
public class DummyRosterContent {
    ...
    static {
        ...
        addItem(new Student("J07011","3060581500000", "いとう","しょうた","伊藤","翔太","伊藤翔太",thisTime,new TotalAttendance(12,1),new Message("　","　","　")));
        thisTime = new ThisClassTime("3060580000000204",new AttendanceState(0,null,null));
        ...
        addItem(new Student("B12042","3060581500002", "きとう","たつや","木藤","龍也","木藤達也",thisTime,new TotalAttendance(10,3),new Message("学生課より","学生課へ来て下さい.","保護者の方から学校に来ているかの相談を受けました.きちんと学校に来ているかを本人に確認して下さい.")));
        thisTime = new ThisClassTime("3060580000000207",new AttendanceState(0,null,"　"));
        addItem(new Student("G09052","3060581500003", "きむら","たつや","木村","龍也","木村達也",thisTime,new TotalAttendance(12,1),null));
        thisTime = new ThisClassTime("3060580000000208",new AttendanceState(0,"","　"));
        addItem(new Student("E13062","3060581500004", "くずや","たつや","葛谷","龍也","葛谷達也",thisTime,new TotalAttendance(11,2),new Message("　","　","　")));
        thisTime = new ThisClassTime("3060580000000209",new AttendanceState(0,null,"　"));
        addItem(new Student("A03072","3060581500005", "こみや","たつや","込野","龍也","込野達也",thisTime,new TotalAttendance(10,3),null));
        thisTime = new ThisClassTime("3060580000000210",new AttendanceState(0,"","　"));
        ...
        thisTime = new ThisClassTime("3060580000000213",new AttendanceState(0,"","　"));
        addItem(new Student("E13062","3060581500008", "すずむら","たつや","鈴村","龍也","鈴村達也",thisTime,new TotalAttendance(13,0),null));
        thisTime = new ThisClassTime("3060580000000214",new AttendanceState(0,null,"　"));
        addItem(new Student("A03072","3060581500009", "せと","たつや","瀬戸","龍也","瀬戸達也",thisTime,new TotalAttendance(10,3),new Message("　","　","　")));
        thisTime = new ThisClassTime("3060580000000204",new AttendanceState(0,null,"　"));
        ...
        thisTime = new ThisClassTime("3060580000000204",new AttendanceState(1,null,null));
        addItem(new Student("A03072","3060581500013", "ひびの","たつや","日比野","龍也","日比野達也",thisTime,new TotalAttendance(8,5),null));
        thisTime = new ThisClassTime("3060580000000214",new AttendanceState(1,null,null));
        ...
        thisTime = new ThisClassTime("3060580000000214",new AttendanceState(1,null,null));
        addItem(new Student("A03072","3060581500009", "むとう","たつや","武藤","龍也","武藤達也",thisTime,new TotalAttendance(13,0),new Message("　","　","　")));
        thisTime = new ThisClassTime("3060580000000204",new AttendanceState(1,null,null));
        addItem(new Student("B12042","3060581500010", "めの","たつや","目野","龍也","目野達也",thisTime,new TotalAttendance(13,0),null));
        thisTime = new ThisClassTime("3060580000000204",new AttendanceState(1,null,null));
        addItem(new Student("G09052","3060581500011", "もの","たつや","物","龍也","物達也",thisTime,new TotalAttendance(12,1),null));
        thisTime = new ThisClassTime("3060580000000204",new AttendanceState(1,null,null));
